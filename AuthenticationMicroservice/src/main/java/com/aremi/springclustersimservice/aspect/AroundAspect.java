package com.aremi.springclustersimservice.aspect;
...
/**
 * Classe AOP che centralizza la registrazione delle metriche su Prometheus
 */
...
public class AroundAspect {
     ...
     * @throws Throwable
     */
    @Around("execution(* com.aremi.springclustersimservice.controller.*.*(..))")
    ...
    @Around("execution(* com.aremi.springclustersimservice.repository.*.*(..))")
    ...
    @Around("execution(* com.aremi.springclustersimservice.service.MessageProducer.send*(..))")
